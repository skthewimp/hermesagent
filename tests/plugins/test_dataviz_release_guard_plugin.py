...
SPEC = importlib.util.spec_from_file_location("dataviz_release_guard_plugin", PLUGIN_PATH)
assert SPEC and SPEC.loader
PLUGIN = importlib.util.module_from_spec(SPEC)
sys.modules[SPEC.name] = PLUGIN
SPEC.loader.exec_module(PLUGIN)

find_released_artifact = PLUGIN.find_released_artifact
is_chart_repair_request = PLUGIN.is_chart_repair_request
on_pre_llm_call = PLUGIN.on_pre_llm_call
on_transform_llm_output = PLUGIN.on_transform_llm_output
