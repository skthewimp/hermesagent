...
VISION_ANALYZE_SCHEMA = {
    ...
    "description": (
        ...
        "and you read the pixels yourself on the next turn. Do not call this "
        "for an image already attached inline to the current user message; "
        "you can already see those pixels. Call it for an image available "
        "only by filepath, URL, or tool output (for example a browser "
        "screenshot). For "
