...
_HERMES_CORE_TOOLS = [
    ...
    "send_message", "whatsapp", "inbound_catchup",
...
TOOLSETS = {
    ...
    "messaging": {
        "description": "Cross-platform messaging: send messages and catch up on inbound WhatsApp/email.",
        "tools": ["send_message", "whatsapp", "inbound_catchup"],
        "includes": []
    },
