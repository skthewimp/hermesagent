...
_HERMES_CORE_TOOLS = [
    ...
    "send_message", "whatsapp", "inbound_catchup", "personal_followups",
...
TOOLSETS = {
    ...
    "messaging": {
        "description": "Cross-platform messaging: send messages, catch up on inbound WhatsApp/email, and manage personal follow-ups.",
        "tools": ["send_message", "whatsapp", "inbound_catchup", "personal_followups"],
        "includes": []
    },
