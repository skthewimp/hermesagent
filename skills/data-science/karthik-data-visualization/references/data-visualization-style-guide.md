...
- [Faceting](#faceting)
- [Chart Type Preferences](#chart-type-preferences)
- [Composition](#composition)
- [R ggplot Template](#r-ggplot-template)
- [R Bangalore Weather Template](#r-bangalore-weather-template)
- [Python Preference](#python-preference)
- [Python plotnine Template](#python-plotnine-template)
- [Python matplotlib Template](#python-matplotlib-template)
- [Tufte-Inspired Analytical Rules](#tufte-inspired-analytical-rules)
